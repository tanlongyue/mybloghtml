let message = new Vue({
    ...
    methods:{
        getMessage(){
            $.get(serverIp+"authc/queryMessageAll",{contentType:"application/json;charset=UTF-8",dataType:"json",token:getCookie("SESSION")},function (res) {
                console.log(res)
                if(res.code == -3){
                    removeCookie("userId");
        ...
        replay(message){
            ...
            $("textarea").attr("placeholder","@"+message.userInfo.userNickName);
